<script lang="ts">
    ...
    export let gainerAndLoosersData: any = undefined;
        ...
        >
            ...
            <div class="tableChart">
                ...
                >
                    ...
                    <tbody>
                        {#each gainerAndLoosersData?.[selectedExchangeValue === DROPDOWN_VALUE[0].value ? "NSE_GAINERS_LOSERS" : "ALL_SECURITIES_DATA"] as symbolRow, i}
