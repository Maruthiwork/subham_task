<script lang="ts">
    ...
    export let data: any;
    const { rssList,seoRssData,envDetails,language,canonicalUrl,getParentCategory } = data?.props;
...
<div class="contentWrapper flex flex-col gap-5">
    <div class="innerLeftBlock">
        ...
        <div class="rssCol">
            {#if rssList}
                <div class="grid desktop:grid-cols-3 grid-cols-2 gap-4">
                    {#each rssList as item}
                        <div class="flex flex-row justify-between">
                            ...
                            <div>
                                <a target="_blank" href={rssUrl(item?.completeSlug)}>
