...
import { fetchAllPoll, fetchRightBarData, fetchTrendingStories } from "../../api/fetchData";
...
export async function load(props) {
    ...
    try {
        const [pollData, trending, rightSideBar] = await Promise.all([
            fetchAllPoll(language, 'all'),
